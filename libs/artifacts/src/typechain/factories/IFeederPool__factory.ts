...
export class IFeederPool__factory {
  static readonly abi = _abi;
  static createInterface(): IFeederPoolInterface {
    return new utils.Interface(_abi) as IFeederPoolInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): IFeederPool {
    return new Contract(address, _abi, signerOrProvider) as IFeederPool;
  }
}
