...
export type FeederPoolsPolygonQueryVariables = {
  account: Scalars['String'];
  hasAccount: Scalars['Boolean'];
};


export type FeederPoolsPolygonQuery = { feederPools: Array<(
    ...
    ), token: TokenAllFragment, fasset: TokenAllFragment, masset: Pick<Token, 'id'>, accounts: Array<(
...
export type FeederTokensPolygonQueryVariables = {};


export type FeederTokensPolygonQuery = { feederPools: Array<{ token: TokenAllFragment, fasset: TokenAllFragment }> };
...
export const BoostedSavingsVaultAllFragmentDoc = gql`
  ...
  accounts(where: {account: $account}) @include(if: $hasAccount) {
    ...
    `;
export const FeederPoolsPolygonDocument = gql`
...
/**
 * __useFeederPoolsPolygonQuery__
 *
 * To run a query within a React component, call `useFeederPoolsPolygonQuery` and pass it any options that fit your needs.
 * When your component renders, `useFeederPoolsPolygonQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useFeederPoolsPolygonQuery({
 *   variables: {
 ...
 * });
 */
export function useFeederPoolsPolygonQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<FeederPoolsPolygonQuery, FeederPoolsPolygonQueryVariables>) {
        return ApolloReactHooks.useQuery<FeederPoolsPolygonQuery, FeederPoolsPolygonQueryVariables>(FeederPoolsPolygonDocument, baseOptions);
      }
export function useFeederPoolsPolygonLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<FeederPoolsPolygonQuery, FeederPoolsPolygonQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<FeederPoolsPolygonQuery, FeederPoolsPolygonQueryVariables>(FeederPoolsPolygonDocument, baseOptions);
        }
export type FeederPoolsPolygonQueryHookResult = ReturnType<typeof useFeederPoolsPolygonQuery>;
export type FeederPoolsPolygonLazyQueryHookResult = ReturnType<typeof useFeederPoolsPolygonLazyQuery>;
export type FeederPoolsPolygonQueryResult = ApolloReactCommon.QueryResult<FeederPoolsPolygonQuery, FeederPoolsPolygonQueryVariables>;
export const FeederTokensPolygonDocument = gql`
...
/**
 * __useFeederTokensPolygonQuery__
 *
 * To run a query within a React component, call `useFeederTokensPolygonQuery` and pass it any options that fit your needs.
 * When your component renders, `useFeederTokensPolygonQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useFeederTokensPolygonQuery({
 *   variables: {
 *   },
 * });
 */
export function useFeederTokensPolygonQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<FeederTokensPolygonQuery, FeederTokensPolygonQueryVariables>) {
        return ApolloReactHooks.useQuery<FeederTokensPolygonQuery, FeederTokensPolygonQueryVariables>(FeederTokensPolygonDocument, baseOptions);
      }
export function useFeederTokensPolygonLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<FeederTokensPolygonQuery, FeederTokensPolygonQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<FeederTokensPolygonQuery, FeederTokensPolygonQueryVariables>(FeederTokensPolygonDocument, baseOptions);
        }
export type FeederTokensPolygonQueryHookResult = ReturnType<typeof useFeederTokensPolygonQuery>;
export type FeederTokensPolygonLazyQueryHookResult = ReturnType<typeof useFeederTokensPolygonLazyQuery>;
export type FeederTokensPolygonQueryResult = ApolloReactCommon.QueryResult<FeederTokensPolygonQuery, FeederTokensPolygonQueryVariables>;