...
export type RewardsDistributor_Filter = {
  ...
  fundManagers_contains_nocase?: Maybe<Array<Scalars['Bytes']>>;
  fundManagers_not_contains?: Maybe<Array<Scalars['Bytes']>>;
  fundManagers_not_contains_nocase?: Maybe<Array<Scalars['Bytes']>>;
  /** Filter for the block changed event. */
  _change_block?: Maybe<BlockChangedFilter>;
};
...
export type StakingBalance_Filter = {
  ...
  stakingRewardsContract_contains_nocase?: Maybe<Scalars['String']>;
  stakingRewardsContract_not_contains?: Maybe<Scalars['String']>;
  stakingRewardsContract_not_contains_nocase?: Maybe<Scalars['String']>;
  stakingRewardsContract_starts_with?: Maybe<Scalars['String']>;
  stakingRewardsContract_starts_with_nocase?: Maybe<Scalars['String']>;
  stakingRewardsContract_not_starts_with?: Maybe<Scalars['String']>;
  stakingRewardsContract_not_starts_with_nocase?: Maybe<Scalars['String']>;
  stakingRewardsContract_ends_with?: Maybe<Scalars['String']>;
  stakingRewardsContract_ends_with_nocase?: Maybe<Scalars['String']>;
  stakingRewardsContract_not_ends_with?: Maybe<Scalars['String']>;
  stakingRewardsContract_not_ends_with_nocase?: Maybe<Scalars['String']>;
  stakingRewardsContract_?: Maybe<StakingRewardsContract_Filter>;
...
export type StakingReward_Filter = {
  ...
  type_in?: Maybe<Array<StakingRewardType>>;
  type_not_in?: Maybe<Array<StakingRewardType>>;
  /** Filter for the block changed event. */
  _change_block?: Maybe<BlockChangedFilter>;
};
...
export type StakingRewardsContract_Filter = {
  ...
  type_in?: Maybe<Array<StakingRewardsContractType>>;
  type_not_in?: Maybe<Array<StakingRewardsContractType>>;
  ...
  rewardsDistributor_contains_nocase?: Maybe<Scalars['String']>;
  rewardsDistributor_not_contains?: Maybe<Scalars['String']>;
  rewardsDistributor_not_contains_nocase?: Maybe<Scalars['String']>;
  rewardsDistributor_starts_with?: Maybe<Scalars['String']>;
  rewardsDistributor_starts_with_nocase?: Maybe<Scalars['String']>;
  rewardsDistributor_not_starts_with?: Maybe<Scalars['String']>;
  rewardsDistributor_not_starts_with_nocase?: Maybe<Scalars['String']>;
  rewardsDistributor_ends_with?: Maybe<Scalars['String']>;
  rewardsDistributor_ends_with_nocase?: Maybe<Scalars['String']>;
  rewardsDistributor_not_ends_with?: Maybe<Scalars['String']>;
  rewardsDistributor_not_ends_with_nocase?: Maybe<Scalars['String']>;
  rewardsDistributor_?: Maybe<RewardsDistributor_Filter>;
  ...
  stakingBalances_?: Maybe<StakingBalance_Filter>;
  stakingRewards_?: Maybe<StakingReward_Filter>;
  claimRewardTransactions_?: Maybe<StakingRewardsContractClaimRewardTransaction_Filter>;
  stakeTransactions_?: Maybe<StakingRewardsContractStakeTransaction_Filter>;
  withdrawTransactions_?: Maybe<StakingRewardsContractWithdrawTransaction_Filter>;
  ...
  platformToken_contains_nocase?: Maybe<Scalars['String']>;
  platformToken_not_contains?: Maybe<Scalars['String']>;
  platformToken_not_contains_nocase?: Maybe<Scalars['String']>;
  platformToken_starts_with?: Maybe<Scalars['String']>;
  platformToken_starts_with_nocase?: Maybe<Scalars['String']>;
  platformToken_not_starts_with?: Maybe<Scalars['String']>;
  platformToken_not_starts_with_nocase?: Maybe<Scalars['String']>;
  platformToken_ends_with?: Maybe<Scalars['String']>;
  platformToken_ends_with_nocase?: Maybe<Scalars['String']>;
  platformToken_not_ends_with?: Maybe<Scalars['String']>;
  platformToken_not_ends_with_nocase?: Maybe<Scalars['String']>;
  platformToken_?: Maybe<Token_Filter>;
  platformRewardRate?: Maybe<Scalars['BigInt']>;
...
export type StakingRewardsContractDetailsFragment = { id: string, type: StakingRewardsContractType, duration: number, lastUpdateTime: number, periodFinish: number, rewardRate: string, rewardPerTokenStored: string, platformRewardPerTokenStored?: string | null | undefined, platformRewardRate?: string | null | undefined, totalSupply: string, totalStakingRewards: string, totalPlatformRewards?: string | null | undefined, address: string, stakingToken: { id: string, address: string, decimals: number, symbol: string, totalSupply: { exact: string, decimals: number, simple: string } }, rewardsToken: { id: string, address: string, decimals: number, symbol: string, totalSupply: { exact: string, simple: string, decimals: number } }, platformToken?: { id: string, address: string, decimals: number, symbol: string, totalSupply: { exact: string, simple: string, decimals: number } } | null | undefined };
...
export type StakingRewardsContractQuery = { stakingRewardsContract?: { id: string, type: StakingRewardsContractType, duration: number, lastUpdateTime: number, periodFinish: number, rewardRate: string, rewardPerTokenStored: string, platformRewardPerTokenStored?: string | null | undefined, platformRewardRate?: string | null | undefined, totalSupply: string, totalStakingRewards: string, totalPlatformRewards?: string | null | undefined, address: string, stakingBalances: Array<{ amount: string }>, stakingRewards: Array<{ amount: string, amountPerTokenPaid: string }>, platformRewards: Array<{ amount: string, amountPerTokenPaid: string }>, stakingToken: { id: string, address: string, decimals: number, symbol: string, totalSupply: { exact: string, decimals: number, simple: string } }, rewardsToken: { id: string, address: string, decimals: number, symbol: string, totalSupply: { exact: string, simple: string, decimals: number } }, platformToken?: { id: string, address: string, decimals: number, symbol: string, totalSupply: { exact: string, simple: string, decimals: number } } | null | undefined } | null | undefined };
...
export type StakingRewardsForStakingTokenQuery = { stakingRewardsContracts: Array<{ id: string, type: StakingRewardsContractType, duration: number, lastUpdateTime: number, periodFinish: number, rewardRate: string, rewardPerTokenStored: string, platformRewardPerTokenStored?: string | null | undefined, platformRewardRate?: string | null | undefined, totalSupply: string, totalStakingRewards: string, totalPlatformRewards?: string | null | undefined, address: string, stakingBalances: Array<{ amount: string }>, stakingRewards: Array<{ amount: string, amountPerTokenPaid: string }>, platformRewards: Array<{ amount: string, amountPerTokenPaid: string }>, stakingToken: { id: string, address: string, decimals: number, symbol: string, totalSupply: { exact: string, decimals: number, simple: string } }, rewardsToken: { id: string, address: string, decimals: number, symbol: string, totalSupply: { exact: string, simple: string, decimals: number } }, platformToken?: { id: string, address: string, decimals: number, symbol: string, totalSupply: { exact: string, simple: string, decimals: number } } | null | undefined }> };
...
/**
 * __useStakingRewardsForStakingTokenQuery__
 *
 * To run a query within a React component, call `useStakingRewardsForStakingTokenQuery` and pass it any options that fit your needs.
 * When your component renders, `useStakingRewardsForStakingTokenQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useStakingRewardsForStakingTokenQuery({
 *   variables: {
 *      stakingToken: // value for 'stakingToken'
 *      account: // value for 'account'
 *   },
 * });
 */
