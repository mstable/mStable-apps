...
import { FraxStakingProvider, useFraxStakingState } from '../../../context/FraxStakingProvider'
import { PokeBoost } from '../../../components/PokeBoost'
import { useFeederPoolApy } from '../../../hooks/useFeederPoolApy'
import { FraxTimelock } from './Frax/FraxTimelock'
import { AssetCardV2 } from '../cards/AssetCardV2'
import { HeaderCardV2 } from '../cards/HeaderCardV2'
...
const PoolDetailContent: FC = () => {
  ...
  const apy = useFeederPoolApy(address)
  ...
  const isFraxFeeder = !isEthereum
  const fraxStakingState = useFraxStakingState()
  ...
  return (
    <RewardStreamsProvider vault={vault}>
      <Container>
        ...
        <HeaderContainer>
          <HeaderCardV2 poolAddress={address} color={color} />
